...
describe("Klinefelter-Insurance Auto Quote Form Test", function () {
  it("Form submits properly", function (done) {
    ...
    d.get("localhost:8000").then(function () {
      ...
      // d.findElement(by.id("successMessage")).getText().then(function (success) {
      //   expect(success).to.include("We will contact you shortly with a quote from one of our carriers");
      //   done();
      // });
    });
  });
