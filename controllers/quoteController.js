...
module.exports = (function(){
  return {
    auto: function(req, res) {
      ...
      for (var i = 0; i < newAutoQuote.drivers.length; i++) {
        if (i == 0) {
          drivers_string += "<li>Primary driver name: " + newAutoQuote.drivers[i].driver_name + "</li><li>Primary driver birthday: " + newAutoQuote.drivers[i].driver_bday + "</li><li>Primary driver license number: " + newAutoQuote.drivers[i].driver_license_number + "</li><li>Primary driver license state: " + newAutoQuote.drivers[i].driver_license_state + "</li><li>Primary driver accidents in the last 5 years?: " + newAutoQuote.drivers[i].tickets_accidents_last_five_years + "</l1>"
        } else {
          drivers_string += "<l1>Driver name: " + newAutoQuote.drivers[i].driver_name + "</li>Driver birthday: " + newAutoQuote.drivers[i].driver_bday + "</li><li>Driver license number: " + newAutoQuote.drivers[i].driver_license_number + "</li><li>Driver license state: " + newAutoQuote.drivers[i].driver_license_state + "</li><li>Driver accidents in the last 5 years?: " + newAutoQuote.drivers[i].tickets_accidents_last_five_years + "</l1>"
        }
      }
